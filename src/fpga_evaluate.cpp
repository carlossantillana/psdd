...
void load12Bit(const ap_uint<12>* data_dram, ap_uint<12>* data_local, int burstLength){
 ...
 void load(ap_uint<21>  local_serialized_nodes [580817], ap_uint<21>  serialized_nodes [580817], FPGAPsddNodeStruct local_fpga_node_vector[580817],
   FPGAPsddNodeStruct fpga_node_vector[580817], ap_uint<22> local_children_vector[1541021], ap_uint<22> children_vector[1541021],
    ap_fixed<21,8,AP_RND > local_parameter_vector[770511], ap_fixed<21,8,AP_RND > parameter_vector[770511],
    ap_fixed<14,2,AP_RND > local_bool_param_vector [792], ap_fixed<14,2,AP_RND > bool_param_vector [792],
   ...
   loadFloatsSmall(bool_param_vector, local_bool_param_vector, 792);
   return;
 }
...
//FPGA
 void fpga_evaluate(bool variables[MAX_VAR],
                      ...
                      ap_uint<21>  serialized_nodes [580817],
  ...
  ap_uint<21> local_serialized_nodes [580817];
  FPGAPsddNodeStruct local_fpga_node_vector[580817];
  ap_uint<22> local_children_vector[1541021];
  ap_fixed<21,8,AP_RND > local_parameter_vector[770511];
  ap_fixed<14,2,AP_RND > local_bool_param_vector[792];
