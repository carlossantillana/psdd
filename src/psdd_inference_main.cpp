...
int main(int argc, char** argv)
{
 ...
 if (strcmp(query, "mpe_query") == 0) {
  ...
  if (strcmp(psdd_filename, "../networks/blockmap.psdd") == 0){
    File.open("mpeMasterMind.txt");
     for (int a = 0; a < NUM_DISTICT_QUERIES; a++){
       string current = "";
       File >> current;
 ...
 if (strcmp(psdd_filename, "../networks/BN_78.psdd") == 0){
   File.open("mpeMasterMind.txt");
    for (int a = 0; a < NUM_DISTICT_QUERIES; a++){
      string current = "";
      File >> current;
...
if (strcmp(psdd_filename, "../networks/fs-04.psdd") == 0){
  File.open("mpeMasterMind.txt");
   for (int a = 0; a < NUM_DISTICT_QUERIES; a++){
     string current = "";
     File >> current;
...
if (strcmp(psdd_filename, "../networks/students.psdd") == 0){
  File.open("mpeMasterMind.txt");
   for (int a = 0; a < NUM_DISTICT_QUERIES; a++){
     string current = "";
     File >> current;
