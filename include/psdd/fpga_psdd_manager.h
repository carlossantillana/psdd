...
FPGAPsddNode *ReadFPGAPsddFile(const char *psdd_filename, uintmax_t flag_index,
 ...
 FPGAPsddNode *ReadFPGAPsddFileOld(const char *psdd_filename, uintmax_t flag_index, std::vector<PsddNodeStruct,aligned_allocator<PsddNodeStruct>> &fpga_node_vector,
